...
namespace ReversiMvcApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            ReversiDbContext reversiDbContext)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded) {
                    ...
                    Speler speler = new Speler() { Guid = user.Id, Naam = Input.PlayerName, AantalGelijk = 0, AantalGewonnen = 0, AantalVerloren = 0 };
                    var resultSpeler = await _reversiDbContext.Spelers.AddAsync(speler);
